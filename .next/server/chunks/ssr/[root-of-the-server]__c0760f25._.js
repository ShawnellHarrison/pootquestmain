...
"[project]/src/ai/flows/data:563575 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$563575__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:563575 [app-ssr] (ecmascript) <text/javascript>");
        ...
        const fetchInitialData = async ()=>{
            ...
            try {
                ...
                if (narrativeContextSnap.exists() && characterSnap.exists()) {
                    ...
                    // After a battle, the character data from the DB is our source of truth.
                    // The battle state from the URL just provides context for the narration.
                    setNarrativeContext({
                        ...narrativeData,
                        triggerNextScenario: !!initialBattleState,
                        lastNarration: initialBattleState ? `You are victorious! You found: ${initialBattleState.loot.name}.` : narrativeData.lastNarration
                    });
    ...
    const handleChoice = async (choice)=>{
        ...
        try {
            ...
            if (choice.tags.includes("COMBAT")) {
                ...
                const encounterResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$563575__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["generateEncounter"])({
                    playerClass: characterClassData.name,
            ...
            // --- This is the key change: we write the narrative context back to Firestore ---
            // This ensures if the user closes the tab, their narrative progress is saved.
            ...
            const narrativeContextRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${user.uid}/characters/${characterId}/narrativeContexts`, "main");
            batch.set(narrativeContextRef, newNarrativeContext);
            await batch.commit();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c0760f25._.js.map