...
const AuthForm = ()=>{
    ...
    const handleSignIn = (values)=>{
        if (auth) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initiateEmailSignIn"])(auth, values.email, values.password);
        }
    };
    const handleSignUp = (values)=>{
        if (auth) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initiateEmailSignUp"])(auth, values.email, values.password);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dfe1f5ad._.js.map