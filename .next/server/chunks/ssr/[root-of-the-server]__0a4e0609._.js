...
function AdventureClient({ characterId }) {
    ...
    const [gameState, setGameState] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState("loading");
    ...
    const characterClassData = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useMemo(()=>{
    ...
    const handleChoice = async (choice)=>{
        ...
        if (choice.tags.includes("STEALTH")) {
            updates['reputationStealth'] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["increment"])(5);
        }
        if (choice.tags.includes("COMBAT")) {
            updates['reputationCombat'] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["increment"])(5);
        }
        if (choice.tags.includes("DIPLOMACY")) {
            updates['reputationDiplomacy'] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["increment"])(5);
        }
        try {
            ...
            if (choice.isQuestCompletion) {
                const questId = Object.keys(narrativeContext.questFlags || {}).find((key)=>(narrativeContext.questFlags || {})[key]?.status === 'started');
                if (questId) {
            ...
            if (choice.tags.includes("COMBAT")) {
                ...
                if (npcResult.quest && npcResult.questId) {
                    ...
                    const canAccept = !npcResult.reputationCheck || rep[npcResult.reputationCheck.stat] >= npcResult.reputationCheck.threshold;
                    if (canAccept) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0a4e0609._.js.map