...
"[project]/src/ai/flows/data:34cc14 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$34cc14__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:34cc14 [app-client] (ecmascript) <text/javascript>");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdventureClient.useEffect": ()=>{
            const fetchInitialData = {
                "AdventureClient.useEffect.fetchInitialData": async ()=>{
                    if (!firestore || !user) return;
                    setGameState("loading");
                    try {
                        const narrativeContextRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${user.uid}/characters/${characterId}/narrativeContexts`, "main");
                        const characterDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${user.uid}/characters/${characterId}`);
                        const [narrativeContextSnap, characterSnap] = await Promise.all([
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(narrativeContextRef),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(characterDocRef)
                        ]);
            ...
            }["AdventureClient.useEffect.fetchInitialData"];
            fetchInitialData();
        }
    }["AdventureClient.useEffect"], [
        firestore,
    ...
    const handleChoice = async (choice)=>{
        ...
        try {
            ...
            if (choice.tags.includes("COMBAT")) {
                ...
                const encounterResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$34cc14__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["generateEncounter"])({
                    playerClass: characterClassData.name,
...
_s(AdventureClient, "I6Hf9tgXD/CBwYZWSSdCCunhXh4=", false, function() {
    return [
...
//# sourceMappingURL=src_6ce524b5._.js.map